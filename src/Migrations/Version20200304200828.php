 ...
 */
final class Version20200304200828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event_zimbra (id INT NOT NULL, matiere VARCHAR(255) NOT NULL, nom_formateur VARCHAR(255) NOT NULL, lieu VARCHAR(255) NOT NULL, email_intervenant VARCHAR(255) NOT NULL, description_event VARCHAR(255) NOT NULL, date_debut_event TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fin_event TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
